...
var firebaseURL = 'https://test-5ef88.firebaseio.com/tweets/';
    var userId = user.uid; ;
console.log(userId);
...
function getLikeCount(postID) {
    ...
    var thisPostRef = new Firebase(firebaseURL + userId + '/like-count/');
...
function likePost(id) {
    ...
    document.getElementById('mypr').innerHTML="Number of Likes: " + currentLikes;
        postRef.update({
